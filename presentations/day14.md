...
- This is the first time trying this out
- May be some issues
...
- Coding agent or vibecoding platform
- Give it a prompt in English and it will create a web app for you
- Use further prompts to refine the app, add features, and fix bugs

---

# Big Feelings

- Tools like this are very new
- Changing the way software engineering works
- Lower barrier to entry
- Easy to make custom software just for you!

---

# Why bother to learn to code?

- These tools are imperfect
- They are a *multiplier*
- Experienced developers get more out of these tools
- Sometimes you just gotta look at the code

---

# Demo

- Make me a Gen Z translator
